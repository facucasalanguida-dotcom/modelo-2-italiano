...
module Local3D
  ...
  CAJAS = [
    ...
    ["13 Instalaciones", "aire", "AC1 · cuerpo de la máquina (empotrado en el forjado)", 4.2850, 4.9380, 4.8550, 5.5080, 2.3100, 2.5100],
    ["13 Instalaciones", "aire", "AC1 · Cassette de 4 vías empotrado, al Oeste de P3 · panel de 4 vías", 4.1500, 4.8030, 4.9900, 5.6430, 2.2800, 2.3100],
    ["13 Instalaciones", "rejilla", "AC1 · rejilla de retorno central", 4.3450, 4.9980, 4.7950, 5.4480, 2.2650, 2.2800],
    ["13 Instalaciones", "rejilla", "AC1 · lama de impulsión Sur", 4.2750, 4.8380, 4.8650, 4.9280, 2.2650, 2.2800],
    ["13 Instalaciones", "rejilla", "AC1 · lama de impulsión Norte", 4.2750, 5.5180, 4.8650, 5.6080, 2.2650, 2.2800],
    ["13 Instalaciones", "rejilla", "AC1 · lama de impulsión Oeste", 4.1850, 4.9280, 4.2750, 5.5180, 2.2650, 2.2800],
    ["13 Instalaciones", "rejilla", "AC1 · lama de impulsión Este", 4.8650, 4.9280, 4.9550, 5.5180, 2.2650, 2.2800],
