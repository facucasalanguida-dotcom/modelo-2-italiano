...
nervios: aro superior de 90 con reborde enrollado y dos asas ranuradas
ovaladas opuestas, hombro concavo, cuerpo O 310 con dos nervios de
rodadura (a 40 % y 62 % de la altura desde arriba), aro inferior de 80 con
...
def build():
    ...
    rb = R - 0.005                    # cuerpo cilindrico, 5 mm menor que los aros
    perfil = [(0.0, 0.0), (R - 0.020, 0.0), (R - 0.004, 0.0), (R, 0.004), (R, 0.076), (R - 0.004, 0.080),
              (rb, 0.100), (rb, 0.212), (R - 0.002, 0.222), (R - 0.002, 0.234), (rb, 0.244),
              (rb, 0.348), (R - 0.002, 0.358), (R - 0.002, 0.370), (rb, 0.380),
              (rb, 0.480), (R - 0.004, 0.520), (R, 0.524), (R, 0.596), (R - 0.004, H), (R - 0.020, H),
              (R - 0.020, H - 0.010), (R - 0.030, H - 0.030), (0.110, H - 0.032), (0.060, H - 0.038), (0.030, H - 0.040)]
    ...
    L.tubo('fitting anillo', 0.033, 0.026, 0.006, (0, 0, H - 0.020), segs=64, mat=inox)
